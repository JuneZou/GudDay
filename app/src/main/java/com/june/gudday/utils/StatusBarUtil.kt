...
object StatusBarUtil {
    ...
    var FAKE_STATUS_BAR_VIEW_ID: Int = 0
    var FAKE_TRANSLUCENT_VIEW_ID: Int = 0
    ...
    @JvmOverloads fun setColor(activity: Activity, @ColorInt color: Int, @IntRange(from = 0, to = 255) statusBarAlpha: Int = DEFAULT_STATUS_BAR_ALPHA) {

        FAKE_STATUS_BAR_VIEW_ID = ReflectIdentify.getIdResId("statusbarutil_fake_status_bar_view", activity)
        FAKE_TRANSLUCENT_VIEW_ID = ReflectIdentify.getIdResId("statusbarutil_translucent_view", activity)
     ...
     * @param statusBarAlpha 状态栏透明度
     */
    @JvmOverloads fun setColorForSwipeBack(activity: Activity, @ColorInt color: Int,
     ...
     * @param statusBarAlpha 状态栏透明度
     */
    @JvmOverloads fun setTranslucent(activity: Activity, @IntRange(from = 0, to = 255) statusBarAlpha: Int = DEFAULT_STATUS_BAR_ALPHA) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return
        }
     ...
     * @param drawerLayout DrawerLayout
     */
    @JvmOverloads fun setTranslucentForDrawerLayout(activity: Activity, drawerLayout: DrawerLayout,
                                                    @IntRange(from = 0, to = 255) statusBarAlpha: Int = DEFAULT_STATUS_BAR_ALPHA) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return
        }
